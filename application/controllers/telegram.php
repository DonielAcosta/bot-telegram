...
class Telegram extends Controller {
	...
	function dataedit(){
		...
		$edit->usuarios = new inputField('Usuarios','usuarios');
		$edit->usuarios->rule='';
		$edit->usuarios->size =20;
		$edit->usuarios->maxlength =20;
	...
	function instalar(){
		...
		$mod ='ALTER TABLE telegram CHANGE COLUMN descripcion descripcion VARCHAR(150)';
		$this->db->query($mod);
	}
}
